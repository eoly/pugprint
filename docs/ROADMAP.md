...
- **Phase 5 — Polish + kid features: ✅ DONE 2026-09-22 (tasks 1–9 merged as #24–#33; hardware-verified
  ...
  10. ✅ **Round stickers** — `LabelShape` on a roll's label; "Round stickers" (`circle-49`; measured
     2026-09-22: 1/8 in of liner each side, 1/4 in above and below, i.e. the square roll's
     web, label size, gap and placement) renders through `StickerRoll.render`,
     which clips the dots to the inscribed circle and fits the caption as a cap inside the
     curve. Crop frame, preview and draw sheet all show the circle. A hardware print check is
     still open (docs/TESTING.md).
